# com-chilipeppr-workspace-GRoberts
A ChiliPeppr Workspace for GRoberts.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / GRoberts
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-GRoberts |
| Name                  | Workspace / GRoberts |
| Description           | A ChiliPeppr Workspace for GRoberts. |
...
chilipeppr.load(
  ...
  function() {
    ...
    cprequire(
      ["inline:com-chilipeppr-workspace-GRoberts"], // the id you gave your workspace
      function(myWorkspaceGRoberts) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / GRoberts just got loaded.", myWorkspaceGRoberts);
        myWorkspaceGRoberts.init();
      }
    );
  }
);
