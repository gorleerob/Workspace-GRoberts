...
cprequire_test(["inline:com-chilipeppr-workspace-GRoberts"], function(ws) {
    ...
    $('title').html("GRoberts Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-GRoberts", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-GRoberts", // Make the id the same as the cpdefine id
        name: "Workspace / GRoberts", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace for GRoberts.`,
